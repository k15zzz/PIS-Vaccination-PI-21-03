      ...
      <div class="reg-table__row">
        ...
        <div class="reg-table-row__actions">
          ...
          <div v-for="value in models" class="reg-table-row__action">
            ...
            <svg
                v-if="PermissionService.can(model.getPermission('export'))"
                @click="router.push({name: model.getRouterAction('export'), params:{ id: value.id }})"
                width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd" d="M2,8 L5,2 L8,8" fill="#52616B"/>
            </svg>
